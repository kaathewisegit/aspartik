...
fn test_inverse_cdf() {
	let cases = [
		((1.0, 1.0), 0.99, 6366.864385106232),
		((1.0, 3.0), 0.99, 19098.593155318693),
		((3.0, 1.0), 0.99, 6368.864385106232),
		((3.0, 3.0), 0.99, 19100.593155318693),
		((1.0, 10.0), 0.99, 63659.64385106231),
		((10.0, 1.0), 0.99, 6375.864385106232),
		((10.0, 10.0), 0.99, 63668.64385106231),
		((0.5, 10.0), 0.01, 2.0071824930113973),
