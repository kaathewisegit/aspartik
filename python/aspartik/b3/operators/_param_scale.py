...
@dataclass(slots=True)
class ScaleRealVector(Operator, TunableOperator):
    """Scales a single value in a vector"""
    ...
    def propose(self) -> Proposal:
        ...
        idx = self.rng.random_int(0, len(self.param))

        self.param[idx] = self.param[idx] * scale
