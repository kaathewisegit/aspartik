...
mod tests {
	...
	#[test]
	fn test_min_max() {
		let min = |x: Gumbel| x.lower();
		let max = |x: Gumbel| x.upper();
	...
	fn test_ln_pdf() {
		...
		test_exact(
			0.0,
			0.1,
			3.678794411714423215_f64.ln(),
			ln_pdf(0.0),
		);
		test_absolute(
			0.0,
			0.1,
			0.0004539786865564_f64.ln(),
			1e-12,
			ln_pdf(1.0),
		);
		test_absolute(
		...
		test_exact(
			0.0,
			10.0,
			0.036787944117144233_f64.ln(),
			ln_pdf(0.0),
		);
		test_absolute(
			0.0,
			10.0,
			0.03661041518977401428_f64.ln(),
			1e-12,
			ln_pdf(1.0),
		);
		test_absolute(
