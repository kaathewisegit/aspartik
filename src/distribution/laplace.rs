...
impl Continuous<f64> for Laplace {
...
mod tests {
	...
	fn test_inverse_cdf() {
		let inverse_cdf =
			|arg: f64| move |x: Laplace| x.inverse_cdf(arg);
		let loc = 0.0f64;
		let scale = 1.0f64;
		let reltol = 1e-15f64;
