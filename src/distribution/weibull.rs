...
mod tests {
	...
	fn test_mean() {
		...
		test_absolute(
			10.0,
			10.0,
			9.5135076986687318362924871772654021925505786260884,
			1e-14,
			mean,
		);
		test_absolute(
	...
	fn test_variance() {
		...
		test_absolute(
			10.0,
			10.0,
			1.3100455073468309147154581687505295026863354547057,
			1e-12,
			variance,
		);
		test_absolute(
			10.0,
			1.0,
			0.013100455073468309147154581687505295026863354547057,
			1e-14,
			variance,
		);
	}
	...
	fn test_skewnewss() {
		...
		test_absolute(
			10.0,
			10.0,
			-0.63763713390314440916597757156663888653981696212127,
			1e-11,
			skewness,
		);
		test_absolute(
	...
	fn test_median() {
		...
		test_exact(
			1.0,
			0.1,
			0.069314718055994530941723212145817656807550013436026,
			median,
		);
		test_exact(
			1.0,
		...
		test_exact(
			10.0,
			10.0,
			9.6401223546778973665856033763604752124634905617583,
			median,
		);
		test_exact(
			10.0,
			1.0,
			0.96401223546778973665856033763604752124634905617583,
			median,
		);
	}
	...
	fn test_mode() {
		...
		test_exact(
			10.0,
			10.0,
			9.8951925820621439264623017041980483215553841533709,
			mode,
		);
		test_exact(
			10.0,
			1.0,
			0.98951925820621439264623017041980483215553841533709,
			mode,
		);
	}
	...
	fn test_pdf() {
		...
		test_exact(
			1.0,
			0.1,
			0.00045399929762484851535591515560550610237918088866565,
			pdf(1.0),
		);
		test_exact(
			1.0,
			0.1,
			3.7200759760208359629596958038631183373588922923768e-43,
			pdf(10.0),
		);
		...
		test_absolute(
			10.0,
			10.0,
			9.9999999990000000000499999999983333333333750000000e-10,
			1e-24,
			pdf(1.0),
		);
		test_exact(
		...
		test_exact(
			10.0,
			1.0,
			3.6787944117144232159552377016146086744581113103177,
			pdf(1.0),
		);
	...
	fn test_ln_pdf() {
		...
		test_absolute(
			1.0,
			0.1,
			-7.6974149070059543159820085453156357923988985113712,
			1e-15,
			ln_pdf(1.0),
		);
		test_exact(
			1.0,
			0.1,
			-97.697414907005954315982008545315635792398898511371,
			ln_pdf(10.0),
		);
		...
		test_absolute(
			10.0,
			10.0,
			-20.723265837046411156161923092159277868409913397659,
			1e-14,
			ln_pdf(1.0),
		);
		...
		test_absolute(
			10.0,
			1.0,
			1.3025850929940456840179914546843642076011014886288,
			1e-15,
			ln_pdf(1.0),
		);
	...
	fn test_cdf() {
		...
		test_exact(
			1.0,
			0.1,
			0.99995460007023751514846440848443944938976208191113,
			cdf(1.0),
		);
		test_exact(
			1.0,
		...
		test_exact(
			1.0,
			1.0,
			0.63212055882855767840447622983853913255418886896823,
			cdf(1.0),
		);
		test_exact(
			1.0,
		...
		test_absolute(
			10.0,
			10.0,
			9.9999999995000000000166666666662500000000083333333e-11,
			1e-25,
			cdf(1.0),
		);
		test_exact(
	...
	fn test_inverse_cdf() {
		let func =
			|arg: f64| move |x: Weibull| x.inverse_cdf(x.cdf(arg));
