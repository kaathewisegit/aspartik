...
mod tests {
	...
	fn test_ln_pdf() {
		...
		test_absolute(
			0.1,
			0.1,
			0.0234154207226588982471f64.ln(),
			1e-15,
			ln_pdf(1.0),
		);
		test_absolute(
			1.0,
			0.1,
			0.0396064560910663979961f64.ln(),
			1e-15,
			ln_pdf(1.0),
		);
		test_absolute(
			10.0,
			0.1,
			0.0418440630400545297349f64.ln(),
			1e-13,
			ln_pdf(1.0),
		);
		test_absolute(
		...
		test_absolute(
			1.0,
			1.0,
			0.1591549430918953357689f64.ln(),
			1e-15,
			ln_pdf(1.0),
		);
		test_absolute(
		...
		test_exact(
			0.1,
			0.1,
			0.00221546909694001013517f64.ln(),
			ln_pdf(10.0),
		);
		test_absolute(
			1.0,
			0.1,
			0.00369960370387922619592f64.ln(),
			1e-15,
			ln_pdf(10.0),
		);
		test_absolute(
			10.0,
			0.1,
			0.00390179721174142927402f64.ln(),
			1e-13,
			ln_pdf(10.0),
		);
		test_absolute(
			0.1,
			1.0,
			0.00319864073359931548273f64.ln(),
			1e-15,
			ln_pdf(10.0),
		);
		test_absolute(
			1.0,
			1.0,
			0.009150765837179460915678f64.ln(),
			1e-15,
			ln_pdf(10.0),
		);
		test_exact(
			10.0,
			1.0,
			0.0116493859171442148446f64.ln(),
			ln_pdf(10.0),
		);
		test_absolute(
			0.1,
			10.0,
			0.00305087016058573989694f64.ln(),
			1e-13,
			ln_pdf(10.0),
		);
		test_exact(
			1.0,
			10.0,
			0.00271897749113479577864f64.ln(),
			ln_pdf(10.0),
		);
		test_absolute(
			10.0,
			10.0,
			2.4289227234060500084E-4f64.ln(),
			1e-14,
			ln_pdf(10.0),
		);
	}
	...
	fn test_inverse_cdf() {
		let func = |arg: f64| {
			move |x: FisherSnedecor| x.inverse_cdf(x.cdf(arg))
		};
