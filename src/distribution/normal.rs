...
impl Continuous<f64> for Normal {
...
mod tests {
	...
	fn test_ln_pdf() {
		...
		test_absolute(
			10.0,
			0.1,
			(5.530709549844416159162E-49f64).ln(),
			1e-13,
			ln_pdf(8.5),
		);
		test_absolute(
			10.0,
			0.1,
			(0.5399096651318805195056f64).ln(),
			1e-13,
			ln_pdf(9.8),
		);
		test_absolute(
		...
		test_exact(
			-5.0,
			1.0,
			(1.486719514734297707908E-6f64).ln(),
			ln_pdf(-10.0),
		);
		test_exact(
			-5.0,
			1.0,
			(0.01752830049356853736216f64).ln(),
			ln_pdf(-7.5),
		);
		test_absolute(
			-5.0,
			1.0,
			(0.3989422804014326779399f64).ln(),
			1e-15,
			ln_pdf(-5.0),
		);
		test_exact(
		...
		test_exact(
			0.0,
			10.0,
			(0.03520653267642994777747f64).ln(),
			ln_pdf(-5.0),
		);
		test_exact(
			0.0,
			10.0,
			(0.03866681168028492069412f64).ln(),
			ln_pdf(-2.5),
		);
		test_exact(
			0.0,
			10.0,
			(0.03989422804014326779399f64).ln(),
			ln_pdf(0.0),
		);
		test_exact(
			0.0,
		...
		test_exact(
			10.0,
			100.0,
			(4.398359598042719404845E-4f64).ln(),
			ln_pdf(-200.0),
		);
		test_exact(
			10.0,
			100.0,
			(0.002178521770325505313831f64).ln(),
			ln_pdf(-100.0),
		);
		test_absolute(
			10.0,
			100.0,
			(0.003969525474770117655105f64).ln(),
			1e-15,
			ln_pdf(0.0),
		);
		test_absolute(
			10.0,
			100.0,
			(0.002660852498987548218204f64).ln(),
			1e-15,
			ln_pdf(100.0),
		);
		test_absolute(
			10.0,
			100.0,
			(6.561581477467659126534E-4f64).ln(),
			1e-15,
			ln_pdf(200.0),
		);
		test_exact(
	...
	fn test_inverse_cdf() {
		let inverse_cdf =
			|arg: f64| move |x: Normal| x.inverse_cdf(arg);
