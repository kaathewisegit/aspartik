...
mod tests {
	...
	fn test_entropy() {
		...
		test_exact(
			-1.0,
			2.5,
			1.335229265078827806963856948173628711311498693546,
			entropy,
		);
		test_exact(
			-1.0,
			5.5,
			2.1236866254430979764250411929125703716076041932149,
			entropy,
		);
		test_absolute(
			-0.1,
			0.1,
			-0.9836465597893728922776256101467037894202344606927,
			1e-15,
			entropy,
		);
		test_exact(
			-0.1,
			1.5,
			1.7244036413128371182072277287441840743152295566462,
			entropy,
		);
		test_exact(
			-0.1,
		...
		test_absolute(
			0.1,
			0.1,
			-0.7836465597893728811753953638951383851839177797845,
			1e-15,
			entropy,
		);
		test_absolute(
			0.1,
			1.5,
			1.9244036413128371293094579749957494785515462375544,
			1e-15,
			entropy,
		);
		test_exact(
			0.1,
			2.5,
			2.4352292650788278125149720712994114134296570340001,
			entropy,
		);
		test_exact(
			0.1,
			5.5,
			3.223686625443097981976156316038353073725762533669,
			entropy,
		);
		test_absolute(
			1.5,
		...
		test_exact(
			1.5,
			1.5,
			3.3244036413128371237583428518699667764333878971003,
			entropy,
		);
		test_exact(
			1.5,
			2.5,
			3.835229265078827806963856948173628711311498693546,
			entropy,
		);
		test_exact(
			1.5,
			5.5,
			4.6236866254430979764250411929125703716076041932149,
			entropy,
		);
		test_exact(
			2.5,
			0.1,
			1.6163534402106271132734895129790789126979238797614,
			entropy,
		);
		test_absolute(
			2.5,
			1.5,
			4.3244036413128371237583428518699667764333878971003,
			1e-15,
			entropy,
		);
		test_exact(
		...
		test_exact(
			2.5,
			5.5,
			5.6236866254430979764250411929125703716076041932149,
			entropy,
		);
		test_exact(
			5.5,
			0.1,
			4.6163534402106271132734895129790789126979238797614,
			entropy,
		);
		test_absolute(
			5.5,
			1.5,
			7.3244036413128371237583428518699667764333878971003,
			1e-15,
			entropy,
		);
		test_exact(
			5.5,
			2.5,
			7.835229265078827806963856948173628711311498693546,
			entropy,
		);
		test_exact(
			5.5,
			5.5,
			8.6236866254430979764250411929125703716076041932149,
			entropy,
		);
	}
	...
	fn test_skewness() {
		...
		test_absolute(
			-1.0,
			0.1,
			0.30175909933883402945387113824982918009810212213629,
			1e-14,
			skewness,
		);
		test_exact(
			-1.0,
			1.5,
			33.46804679732172529147579024311650645764144530123,
			skewness,
		);
		test_absolute(
			-1.0,
		...
		test_absolute(
			-1.0,
			5.5,
			50829064464591483629.132631635472412625371367420496,
			1e4,
			skewness,
		);
		test_absolute(
	...
	fn test_mode() {
		...
		test_exact(
			-1.0,
			0.1,
			0.36421897957152331652213191863106773137983085909534,
			mode,
		);
		test_exact(
			-1.0,
			1.5,
			0.03877420783172200988689983526759614326014406193602,
			mode,
		);
		test_exact(
			-1.0,
		...
		test_exact(
			-0.1,
			0.1,
			0.89583413529652823774737070060865897390995185639633,
			mode,
		);
		test_exact(
			-0.1,
			1.5,
			0.095369162215549610417813418326627245539514227574881,
			mode,
		);
		test_exact(
			-0.1,
		...
		test_exact(
			0.1,
			0.1,
			1.0941742837052103542285651753780976842292770841345,
			mode,
		);
		test_exact(
			0.1,
			1.5,
			0.11648415777349696821514223131929465848700730137808,
			mode,
		);
		test_exact(
			0.1,
			2.5,
			0.0021334817700377079925027678518795817076296484352472,
			mode,
		);
		...
		test_exact(
			1.5,
			0.1,
			4.4370955190036645692996309927420381428715912422597,
			mode,
		);
		test_exact(
			1.5,
			1.5,
			0.47236655274101470713804655094326791297020357913648,
			mode,
		);
		test_exact(
			1.5,
			2.5,
			0.008651695203120634177071503957250390848166331197708,
			mode,
		);
		...
		test_exact(
			2.5,
			0.1,
			12.061276120444720299113038763305617245808510584994,
			mode,
		);
		test_exact(
			2.5,
		...
		test_exact(
			5.5,
			0.1,
			242.2572068579541371904816252345031593584721473492,
			mode,
		);
		test_exact(
			5.5,
			1.5,
			25.790339917193062089080107669377221876655268848954,
			mode,
		);
		test_exact(
			5.5,
	...
	fn test_median() {
		...
		test_exact(
			0.1,
			0.1,
			1.1051709180756476309466388234587796577416634163742,
			median,
		);
		test_exact(
			0.1,
		...
		test_exact(
			1.5,
			0.1,
			4.4816890703380648226020554601192758190057498683697,
			median,
		);
		test_exact(
			1.5,
		...
		test_exact(
			2.5,
			0.1,
			12.182493960703473438070175951167966183182767790063,
			median,
		);
		test_exact(
			2.5,
		...
		test_exact(
			5.5,
			0.1,
			244.6919322642203879151889495118393501842287101075,
			median,
		);
		test_exact(
			5.5,
	...
	fn test_pdf() {
		...
		test_exact(
			-0.1,
			0.1,
			2.3363114904470413709866234247494393485647978367885,
			pdf(0.8),
		);
		test_absolute(
			-0.1,
			1.5,
			0.90492497850024368541682348133921492204585092983646,
			1e-15,
			pdf(0.1),
		);
		test_absolute(
		...
		test_exact(
			-0.1,
			1.5,
			0.33133347214343229148978298237579567194870525187207,
			pdf(0.8),
		);
		test_exact(
			-0.1,
			2.5,
			1.0824698632626565182080576574958317806389057196768,
			pdf(0.1),
		);
		test_absolute(
			-0.1,
			2.5,
			0.31029619474753883558901295436486123689563749784867,
			1e-16,
			pdf(0.5),
		);
		test_absolute(
			-0.1,
			2.5,
			0.19922929916156673799861939824205622734205083805245,
			1e-16,
			pdf(0.8),
		);
		...
		test_exact(
			1.5,
			0.1,
			1.6670425710002183246335601541889400558525870482613e-64,
			pdf(0.8),
		);
		test_absolute(
			1.5,
			1.5,
			0.10698412103361841220076392503406214751353235895732,
			1e-16,
			pdf(0.1),
		);
		test_absolute(
			1.5,
			1.5,
			0.18266125308224685664142384493330155315630876975024,
			1e-16,
			pdf(0.5),
		);
		test_absolute(
			1.5,
			1.5,
			0.17185785323404088913982425377565512294017306418953,
			1e-16,
			pdf(0.8),
		);
		test_absolute(
			1.5,
			2.5,
			0.50186885259059181992025035649158160252576845315332,
			1e-15,
			pdf(0.1),
		);
		test_absolute(
			1.5,
			2.5,
			0.21721369314437986034957451699565540205404697589349,
			1e-16,
			pdf(0.5),
		);
		test_exact(
			1.5,
			2.5,
			0.15729636000661278918949298391170443742675565300598,
			pdf(0.8),
		);
		...
		test_absolute(
			2.5,
			1.5,
			0.015806486291412916772431170442330946677601577502353,
			1e-16,
			pdf(0.1),
		);
		test_absolute(
			2.5,
			1.5,
			0.055184331257528847223852028950484131834529030116388,
			1e-16,
			pdf(0.5),
		);
		test_exact(
			2.5,
			1.5,
			0.063982134749859504449658286955049840393511776984362,
			pdf(0.8),
		);
		test_absolute(
			2.5,
			2.5,
			0.25212505662402617595900822552548977822542300480086,
			1e-15,
			pdf(0.1),
		);
		test_absolute(
		...
		test_absolute(
			2.5,
			2.5,
			0.11021452580363707866161369621432656293405065561317,
			1e-16,
			pdf(0.8),
		);
	}
	...
	fn test_ln_pdf() {
		...
		test_exact(
			-0.1,
			0.1,
			-238.88282294119596467794686179588610665317241097599,
			ln_pdf(0.1),
		);
		test_absolute(
			-0.1,
		...
		test_absolute(
			-0.1,
			1.5,
			-0.099903235403144611051953094864849327288457482212211,
			1e-15,
			ln_pdf(0.1),
		);
		test_absolute(
		...
		test_absolute(
			-0.1,
			1.5,
			-1.1046299420497998262946038709903250420774183529995,
			1e-15,
			ln_pdf(0.8),
		);
		test_absolute(
			-0.1,
			2.5,
			0.07924534056485078867266307735371665927517517183681,
			1e-16,
			ln_pdf(0.1),
		);
		test_exact(
			-0.1,
			2.5,
			-1.1702279707433794860424967893989374511050637417043,
			ln_pdf(0.5),
		);
		test_exact(
			-0.1,
			2.5,
			-1.6132988605030400828957768752511536087538109996183,
			ln_pdf(0.8),
		);
		test_exact(
			1.5,
			0.1,
			-719.29643782024317312262673764204041218720576249741,
			ln_pdf(0.1),
		);
		test_absolute(
			1.5,
		...
		test_exact(
			1.5,
			0.1,
			-146.85439481068371057247137024006716189469284256628,
			ln_pdf(0.8),
		);
		test_absolute(
			1.5,
			1.5,
			-2.2350748570877992856465076624973458117562108140674,
			1e-15,
			ln_pdf(0.1),
		);
		test_absolute(
			1.5,
			1.5,
			-1.7001219175524556705452882616787223585705662860012,
			1e-15,
			ln_pdf(0.5),
		);
		test_absolute(
			1.5,
			1.5,
			-1.7610875785399045023354101841009649273236721172008,
			1e-15,
			ln_pdf(0.8),
		);
		test_absolute(
		...
		test_absolute(
			2.5,
			0.1,
			-1149.5549471196476523788026360929146688367845019398,
			1e-12,
			ln_pdf(0.1),
		);
		test_absolute(
		...
		test_absolute(
			2.5,
			0.1,
			-369.16874994210463740474549611573497379941224077335,
			1e-13,
			ln_pdf(0.8),
		);
		test_absolute(
			2.5,
			1.5,
			-4.1473348984184862316495477617980296904955324113457,
			1e-15,
			ln_pdf(0.1),
		);
		test_absolute(
			2.5,
			1.5,
			-2.8970762200235424747307247601045786110485663457169,
			1e-15,
			ln_pdf(0.5),
		);
		test_exact(
			2.5,
			1.5,
			-2.7491513791239977024488074547907467152956602019989,
			ln_pdf(0.8),
		);
		test_absolute(
			2.5,
			2.5,
			-1.3778300581206721947424710027422282714793718026513,
			1e-15,
			ln_pdf(0.1),
		);
		test_exact(
			2.5,
			2.5,
			-1.9577771978563167352868858774048559682046428490575,
			ln_pdf(0.5),
		);
		test_exact(
			2.5,
			2.5,
			-2.2053265778497513183112901654193054111123780652581,
			ln_pdf(0.8),
		);
	}
	...
	fn cdf_tests(inverse: bool) {
		...
		let almost = |mean: f64,
		              ...
		              acc: f64| {
			let (input, output) =
				arrange_input_output(cdf_input, cdf_output);
		...
		almost(
			...
			0.1,
			0.8,
			0.10908001076375810900224507908874442583171381706127,
			1e-11,
		);
		almost(
			-0.1,
			1.5,
			0.1,
			0.070999149762464508991968731574953594549291668468349,
			1e-11,
		);
		case(
			-0.1,
		...
		case(
			...
			1.5,
			0.8,
			0.46728530589487698517090261668589508746353129242404,
		);
		almost(
			-0.1,
			2.5,
			0.1,
			0.18914969879695093477606645992572208111152994999076,
			1e-10,
		);
		case(
			-0.1,
			2.5,
			0.5,
			0.40622798321378106125020505907901206714868922279347,
		);
		case(
			-0.1,
			2.5,
			0.8,
			0.48035707589956665425068652807400957345208517749893,
		);
		...
		almost(
			...
			1.5,
			0.1,
			0.005621455876973168709588070988239748831823850202953,
			1e-12,
		);
		almost(
			1.5,
			1.5,
			0.8,
			0.12532699044614938400496547188720940854423187977236,
			1e-11,
		);
		almost(
			1.5,
			2.5,
			0.1,
			0.064125647996943514411570834861724406903677144126117,
			1e-11,
		);
		almost(
			1.5,
			2.5,
			0.5,
			0.19017302281590810871719754032332631806011441356498,
			1e-10,
		);
		almost(
			1.5,
			2.5,
			0.8,
			0.24533064397555500690927047163085419096928289095201,
			1e-16,
		);
		...
		almost(
			...
			1.5,
			0.1,
			0.00068304052220788502001572635016579586444611070077399,
			1e-13,
		);
		almost(
			2.5,
		...
		almost(
			...
			1.5,
			0.8,
			0.034729001282904174941366974418836262996834852343018,
			1e-11,
		);
		almost(
			2.5,
			2.5,
			0.1,
			0.027363708266690978870139978537188410215717307180775,
			1e-11,
		);
		almost(
			2.5,
			2.5,
			0.5,
			0.10075543423327634536450625420610429181921642201567,
			1e-11,
		);
		almost(
			2.5,
			2.5,
			0.8,
			0.13802019192453118732001307556787218421918336849121,
			1e-11,
		);
	}
